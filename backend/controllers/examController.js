...
//     // Check if exam already exists and is in progress
...
//     // if (existingExam) {
//     //   return res.status(200).json({ success: true, exam: existingExam });
//     // }
...
//     if (attemptCount >= application.test.maxAttempts) {
//       return res
//         .status(400)
...
//     const questions = await Question.find({ test: application.test._id }).sort({
//       order: 1,
//     });
